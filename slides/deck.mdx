...
import omioLogo from '../assets/omio-logo.png';
import getHelp from '../assets/get-some-help.gif';
import whyNot from '../assets/why-not.gif';
import getStarted from '../assets/get-started.gif';
import notFitting from '../assets/not-fitting.gif';
import mindBlow from '../assets/mind-blow.gif';
...
<img src={cover} alt="Photo by Brendan Church on Unsplash" />
...
<CustomizableImage src={profile} alt="profile" round />
...
<CustomizableImage src={omioLogo} alt="Omio Logo" maxWidth="600px" />
...
<img src={getHelp} alt="Get some help" />
...
<CustomizableImage src={getStarted} alt="Get Started" width="500px" />
...
<img src={mindBlow} alt="Mind blow" />
